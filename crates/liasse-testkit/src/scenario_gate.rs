...
pub const SKIP: &[(&str, &str)] = &[
    ...
    // --- `host_load` step ---
    ("09-loading-bootstrap/definition-only-update-creates-commit", "`host_load` step not driven this phase"),
    ("09-loading-bootstrap/rejected-update-leaves-prior-active", "`host_load` step not driven this phase"),
    ("09-loading-bootstrap/reload-divergent-seed-data-unspecified", "`host_load` step not driven this phase"),
    ("09-loading-bootstrap/reload-identical-definition-unchanged", "`host_load` step not driven this phase"),
    ...
    ("20-evolution-migrations/compatible-field-added-uses-default", "`host_load` step not driven this phase"),
    ...
    ("20-evolution-migrations/dropped-field-absent-from-live-after-migration", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/empty-source-collection-migrates-to-empty", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/from-with-as-transforms-value", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/lossy-roundtrip-single-value-rejects-whole", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/migrated-state-dangling-ref-rejected", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/migrated-value-fails-target-check-rejected", "`host_load` step not driven this phase"),
    ...
    ("20-evolution-migrations/nondeterministic-migration-transform-invalid", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/old-state-is-read-only-in-migration", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/rename-collection-via-from", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/rename-field-via-from-copies-value", "`host_load` step not driven this phase"),
    ...
    ("20-evolution-migrations/roundtrip-inverse-mismatch-rejects", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/sequence-composition-not-mandated-unspecified", "`host_load` step not driven this phase"),
    ("20-evolution-migrations/target-seed-data-on-update-unspecified", "`host_load` step not driven this phase"),
    ("22-runtime-semantics/definition-only-update-commits-with-empty-writable-delta", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/confusable-surface-address-rename-rejected", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/downgrade-drops-populated-field-rejected", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/downgrade-shape-compatible-no-transform-unspecified", "`host_load` step not driven this phase"),
    ...
    ("annex-e-compatibility/major-removes-output-member-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/minor-adds-new-mutation-name-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/minor-adds-optional-output-field-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/minor-adds-optional-parameter-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/minor-adds-private-collection-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/minor-adds-required-parameter-rejected", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/minor-changes-liasse-to-unsupported-generation-rejected", "`host_load` step not driven this phase"),
    ...
    ("annex-e-compatibility/minor-widens-input-enum-domain-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/patch-narrowing-response-rejected", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/patch-private-computation-change-accepted", "`host_load` step not driven this phase"),
    ("annex-e-compatibility/same-version-republish-widened-contract-unspecified", "`host_load` step not driven this phase"),
    // --- `keyring_admin` step ---
    ...
    ("06-expressions/aggregate-empty-input-identities", "host environment row-field shaping gap (engine invariant)"),
    ("06-expressions/aggregate-skips-absent-inputs", "host environment row-field shaping gap (engine invariant)"),
    ("06-expressions/caret-reads-lexical-parent-scope", "host environment row-field shaping gap (engine invariant)"),
    ("06-expressions/decimal-arithmetic-exact", "host environment row-field shaping gap (engine invariant)"),
    ("06-expressions/int-arithmetic-arbitrary-precision", "host environment row-field shaping gap (engine invariant)"),
    ("06-expressions/integer-division-truncates-toward-zero", "host environment row-field shaping gap (engine invariant)"),
    ("06-expressions/selector-set-keys-follow-target-canonical-order", "host environment row-field shaping gap (engine invariant)"),
    ("07-views/aggregate-avg-converts-to-decimal", "host environment row-field shaping gap (engine invariant)"),
    ("07-views/aggregate-empty-input-zero-and-none", "host environment row-field shaping gap (engine invariant)"),
    ("07-views/aggregate-min-skips-absent-inputs", "host environment row-field shaping gap (engine invariant)"),
    ("07-views/distinct-collapses-duplicates-canonical-order", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/bytes-roundtrip-preserves-canonical-base64", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/bytes-wire-is-dollar-bytes-base64", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/date-wire-is-yyyy-mm-dd", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/decimal-wire-has-no-exponent", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/decimal-wire-large-magnitude-no-exponent", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/duration-wire-is-canonical-iso8601", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/empty-bytes-canonical-base64-is-empty-string", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/enum-wire-is-label-not-ordinal", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/enum-wire-is-label-string", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/int-wire-is-decimal-string", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/int-wire-is-json-string-not-number", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/json-array-order-preserved-not-sorted", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/json-null-preserved-as-value", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/json-numbers-compare-numerically", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/json-object-member-order-canonicalized-equal", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/text-wire-preserved-exactly", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/timestamp-wire-is-base10-string", "host environment row-field shaping gap (engine invariant)"),
    ("annex-a-types-wire/uuid-wire-is-lowercase-hyphenated-string", "host environment row-field shaping gap (engine invariant)"),
    ...
    ("annex-c-grammar/empty-view-literal-combinator", "host environment row-field shaping gap (engine invariant)"),
    ...
    ("05-state-model/omitted-child-collections-start-empty", "no value produced (unsupported call path)"),
    ("05-state-model/static-struct-inserts-with-row", "no value produced (unsupported call path)"),
    ...
    ("05-state-model/nested-collection-key-scoped-to-parent", "outcome divergence: expected `rejected` observed `ok`"),
    ("05-state-model/nested-initializer-failure-rejects-parent-insert", "outcome divergence: expected `ok` observed `rejected`"),
    ("05-state-model/nested-unique-scoped-per-parent", "outcome divergence: expected `rejected` observed `ok`"),
    ...
    ("08-mutations-validation/delete-selector-duplicates-first-occurrence", "outcome divergence: expected `ok` observed `rejected`"),
    ("08-mutations-validation/internal-call-failure-rejects-caller-writes", "outcome divergence: expected `rejected` observed `ok`"),
    ("08-mutations-validation/omitted-optional-param-clears-field", "outcome divergence: expected `ok` observed `rejected`"),
    ("08-mutations-validation/replacement-restrict-ref-rejects-transition", "outcome divergence: expected `rejected` observed `ok`"),
    ("08-mutations-validation/zero-match-bulk-patch-returns-unchanged", "outcome divergence: expected `ok` observed `rejected`"),
    ...
    ("15-meters/quantity-less-source-partitions-without-limiting", "outcome divergence: expected `ok` observed `rejected`"),
    ...
    ("21-deletion-erasure/deletion-returns-rows-as-they-existed", "outcome divergence: expected `ok` observed `rejected`"),
    ...
    ("06-expressions/now-advances-with-virtual-clock", "value diverges from expectation"),
    ...
    ("14-buckets/ref-resolves-against-extant-all-domain", "value diverges from expectation"),
    ("14-buckets/request-now-at-exact-expiry-boundary", "value diverges from expectation"),
    // --- fail:viewdiff ---
    ...
    ("06-expressions/root-slash-reads-package-root-from-nested-scope", "view result diverges from expectation"),
    ...
    ("14-buckets/active-from-lower-bound-inclusive", "view result diverges from expectation"),
    ("14-buckets/active-until-upper-bound-exclusive", "view result diverges from expectation"),
    ("14-buckets/expiration-preserves-row-in-all", "view result diverges from expectation"),
    ("14-buckets/temporal-observation-then-commit-ordering", "view result diverges from expectation"),
    ...
    ("22-runtime-semantics/stored-timestamp-frozen-while-clock-advances", "view result diverges from expectation"),

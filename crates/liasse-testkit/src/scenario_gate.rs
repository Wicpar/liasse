...
pub const SKIP: &[(&str, &str)] = &[
    ...
    // --- `operator` step ---
    ("23-host-contract/operator-application-race-either-serial-order", "`operator` step not driven this phase"),
    ("23-host-contract/operator-bypasses-role-authentication", "`operator` step not driven this phase"),
    ("23-host-contract/operator-commit-actor-provenance-unspecified", "`operator` step not driven this phase"),
    ("23-host-contract/operator-commit-advances-live-views", "`operator` step not driven this phase"),
    ("23-host-contract/operator-empty-delta-returns-unchanged", "`operator` step not driven this phase"),
    ("23-host-contract/operator-retains-key-uniqueness", "`operator` step not driven this phase"),
    ("23-host-contract/operator-retains-meter-capacity", "`operator` step not driven this phase"),
    ("23-host-contract/operator-retains-ref-delete-restrict", "`operator` step not driven this phase"),
    ("23-host-contract/operator-transition-atomic-on-failure", "`operator` step not driven this phase"),
    ("23-host-contract/operator-transition-retains-checks", "`operator` step not driven this phase"),
    ("23-host-contract/provider-error-rejects-preserving-committed-state", "`operator` step not driven this phase"),
    // --- `provider_set` step ---
    ...
    ("15-meters/concurrent-spends-exceed-capacity-race", "no view value produced (unsupported view/watch path)"),
    ("15-meters/multi-meter-spend-must-clear-every-meter", "no view value produced (unsupported view/watch path)"),
    ...
    ("15-meters/exact-exhaustion-boundary", "outcome divergence: expected `ok` observed `rejected`"),
    ...
    ("15-meters/ineligible-pool-does-not-fund-spend", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/mid-program-exhaustion-rolls-back-earlier-spend", "outcome divergence: expected `rejected` observed `ok`"),
    ("15-meters/negative-spend-amount-rejected", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/plan-downgrade-preserves-recorded-funding", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/pool-increase-adds-future-availability", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/pool-reduction-clamps-remainder-at-zero", "outcome divergence: expected `ok` observed `rejected`"),
    ...
    ("15-meters/spend-deletion-releases-allocation", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/spend-update-failure-preserves-prior-allocation", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/spend-update-releases-and-reallocates", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/spend-within-capacity-admits", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/unbucketed-source-defaults-to-unbounded-interval", "outcome divergence: expected `ok` observed `rejected`"),
    ("15-meters/zero-amount-spend-produces-no-funding", "outcome divergence: expected `ok` observed `rejected`"),
    ...
    ("06-expressions/double-colon-binds-collection-field-names", "view result diverges from expectation"),
    ...
    // ========================================================================
    ("15-meters/meter-begins-with-zero-capacity", "runtime meter admission does not reject a zero-capacity spend (concurrent-runtime regression)"),
];